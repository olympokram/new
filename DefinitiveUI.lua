...
function Library:Window(title, version, info, preset, closebind)
        ...
        if io.KeyCode == LibraryBind and not table.find(blacklistedKeybinds, io.KeyCode) then
            ...
            task.spawn(function()
                if Drawing and Drawing.new then
                    ...
                    while Main and Main.Visible and ScreenGui.Parent do
    ...
    if CheckDevice() == "Mobile" or CheckDevice() == "Emulator" then
        ...
        table.insert(Library.Connections, QuickCapture.MouseButton1Click:Connect(function()
            if Main and typeof(Main.Visible) == "boolean" then
                ...
                QuickCapture.TextColor3 = Main.Visible and 
    ...
    function Content:Tab(text)
        ...
        function Container:MakeToggle(Idx, Info)
            ...
            local MainToggle = Library:Create('TextButton', {
                ...
                Position = UDim2.new(0.215625003, 0, 0.446271926, 0);
            ...
            local ToggleTitle = Library:Create('TextLabel', {
                ...
                Position = UDim2.new(0.0358126722, 0, 0, 0);
                Size = UDim2.new(0.95, 0, 0, 40);
                Font = Enum.Font.GothamBlack;
                Text = Info.Text or "Example Text";
            ...
            local FrameToggle1 = Library:Create('Frame', {
                ...
                Position = UDim2.new(0.859504104, 0, 0.285714298, 0);
            ...
            local FrameToggle2 = Library:Create('Frame', {
                ...
                Position = UDim2.new(0.0489999987, 0, 0.0930000022, 0);
            ...
            local FrameToggleCircle = Library:Create('Frame', {
                ...
                Position = UDim2.new(0.127000004, 0, 0.222000003, 0);
        ...
        function Container:KeybindToggle(Idx, Info)
        ...
        function Container:MakeDropdown(Idx, Info)
            ...
            local MainDropdown = Library:Create('Frame', {
                ...
                Position = UDim2.new(-0.541071415, 0, -0.532915354, 0);
                Size = UDim2.new(0, 363, 0, 42)
            })
            ...
            local DropdownTitle = Library:Create('TextLabel', {
                ...
                Font = Enum.Font.GothamBlack;
                Text = Info.Text or "Unknown Text";
                TextColor3 = Color3.fromRGB(255, 255, 255);
                TextSize = 14;
                TextXAlignment = Enum.TextXAlignment.Left
            })
            ...
            local DropdownArrow = Library:Create('ImageLabel', {
                ...
                BackgroundColor3 = Color3.fromRGB(255, 255, 255);
                BackgroundTransparency = 1.000;
                Position = UDim2.new(1.65240645, 0, 0.190476194, 0);
            ...
            local Scrolling = Library:Create('ScrollingFrame', {
                ...
                BackgroundTransparency = 1.000;
                BorderSizePixel = 0;
                Position = UDim2.new(-0.00400000019, 0, 1.04999995, 0);
            ...
            function Dropdown:BuildDropdownList()
                ...
                for Idx, Value in next, Values do
                    ...
                    local Button = Library:Create('TextButton', {
                        ...
                        AutoButtonColor = false;
                        BackgroundColor3 = ThemeColor or Color3.fromRGB(0, 0, 255);
                        Font = Enum.Font.SourceSans;
            ...
            function Dropdown:SetValue(Val)
                if not Val then
                    Dropdown.Value = nil
                --[[elseif Dropdown.Multi and Val then
                    local nTable = {};
        ...
        function Container:Colorpicker(Idx, Info)
            ...
            function ColorPicker:Display()
                ...
                --ColorSelection.Position = UDim2.new(ColorPicker.Sat, 0, 1 - ColorPicker.Vib, 0);
                --HueSelection.Position = UDim2.new(0, 0, ColorPicker.Hue, 0);
            ...
            RainbowToggle.MouseButton1Down:Connect(function()
                ...
                if RainbowColorPicker then
                    ...
                    --FrameRainbowToggle3.BackgroundTransparency = 0
            ...
            function ColorPicker:SetValueRGB(col, Transparency)
        ...
        function Container:MakeTextbox(Idx, Info)
        ...
        function Container:Bind(Idx, Info)
